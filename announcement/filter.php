...
<div class="img-rounded" style="float: left; background-color: ##FFFFFF; width: 800px; height: 550px; border: 1px solid black; margin: 0px;">
<h3 style="color: #ffffff; background-color: #000000; text-align: center; margin: 0px; padding: 0px;">ALL Announcements (Department: <?php echo $_POST["filter"]; ?>)</h3>
<br>
<?php 
...
$query->bind_param('s', $dep); //bind the parameters
